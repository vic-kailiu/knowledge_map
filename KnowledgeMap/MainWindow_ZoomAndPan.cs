...
namespace KnowledgeMap
{
    ...
    public partial class MainWindow
    {
        ...
        /// <summary>
        /// Event raised on mouse down in the MapView.
        /// </summary> 
        private void MapControl_MouseDown(object sender, MouseButtonEventArgs e)
        {
            MapControl.Focus();
            Keyboard.Focus(MapControl);

            mouseButtonDown = e.ChangedButton;
            origZoomAndPanControlMouseDownPoint = e.GetPosition(zoomAndPanControl);
            origContentMouseDownPoint = e.GetPosition(MapControl);
        ...
        /// <summary>
        /// Event raised on mouse up in the MapView.
        /// </summary>
        private void MapControl_MouseUp(object sender, MouseButtonEventArgs e)
        {
            if (mouseHandlingMode != MouseHandlingMode.None)
            {
                ...
                //
                MapControl.IsClearSelectionOnEmptySpaceClickEnabled = true;
        ...
        /// <summary>
        /// Event raised on mouse move in the MapView.
        /// </summary>
        private void MapControl_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseHandlingMode == MouseHandlingMode.Panning)
            {
                    ...
                    Math.Abs(dragOffset.Y) > dragThreshold)
                {
                    ...
                    MapControl.IsClearSelectionOnEmptySpaceClickEnabled = false;
            ...
            else if (mouseHandlingMode == MouseHandlingMode.DragPanning)
            {
                ...
                //
                Point curContentMousePoint = e.GetPosition(MapControl);
        ...
        private void MapControl_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            if ((Keyboard.Modifiers & ModifierKeys.Shift) == 0)
            {
                Point doubleClickPoint = e.GetPosition(MapControl);
        ...
        private void FitContent_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (MapControl.SelectedNodes.Count > 0)
            {
                nodes = MapControl.SelectedNodes;
            }
            else
            {
                nodes = this.ViewModel.Map.Nodes;
                if (nodes.Count == 0)
                {
                    return;
                }
            ...
            //
            actualContentRect.Inflate(MapControl.ActualWidth / 40, MapControl.ActualHeight / 40);
