...
namespace MapUI
{
    ...
    public class ConnectorItem : ContentControl
    {
        ...
        internal static readonly DependencyProperty ParentMapViewProperty =
            DependencyProperty.Register("ParentMapView", typeof(MapView), typeof(ConnectorItem),
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            {
                if (this.ParentMapView != null &&
                    this.ParentMapView.EnableConnectionDragging)
                {
                    //
        ...
        /// <summary>
        /// Event raised when 'ParentMapView' property has changed.
        /// </summary>
        private static void ParentMapView_PropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        ...
        private void UpdateHotspot()
        {
            if (this.ParentMapView == null)
            {
                // No parent MapView is set.
                return;
            }

            if (!this.ParentMapView.IsAncestorOf(this))
            {
                //
                // The parent MapView is no longer an ancestor of the connector.
                // This happens when the connector (and its parent node) has been removed from the Map.
            ...
            // to the view-model.
            //
            this.Hotspot = this.TransformToAncestor(this.ParentMapView).Transform(centerPoint);
       }
